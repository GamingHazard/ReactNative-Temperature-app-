...
const BedRoomPage = () => {
  ...
  // functions for the power switch of the device
  const togglePowerSwitch = () =>
    setPowerSwitch((previousState) => !previousState);

  // function for the automatic mode of the device
  const toggleAutoSwitch = () =>
    setAutoSwictch((previousState) => !previousState);

  // function for the set temperature
  ...
  // funtion for the buttons that set different conditioner modes
